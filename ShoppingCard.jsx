...
<section className="py-24 relative">
  ...
  data.map((x)=>{
    return(
      ...
      <div className="flex items-center flex-col min-[550px]:flex-row gap-3 min-[550px]:gap-6 w-full max-xl:justify-center max-xl:max-w-xl max-xl:mx-auto">
        <div className="img-box"><img src={x.thumbnail} alt="perfume bottle image" className="xl:w-[140px]" /></div>
      ...
      <div className="flex items-center flex-col min-[550px]:flex-row w-full max-xl:max-w-xl max-xl:mx-auto gap-2">
        ...
        <div className="flex items-center w-full mx-auto justify-center">
          ...
          <button className='text-3xl text-dark'>-</button>
          </button>
          <input type="text" className="border-y border-gray-200 outline-none text-gray-900 font-semibold text-lg w-full max-w-[118px] min-w-[80px] placeholder:text-gray-900 py-[15px] text-center bg-transparent" placeholder={x.qty} />
  ...
  <Link to="/product" className="rounded-full w-full max-w-[280px] py-4 text-center justify-center items-center bg-indigo-600 font-semibold text-lg text-white flex transition-all duration-500 hover:bg-indigo-700">Continue
  to Payment
